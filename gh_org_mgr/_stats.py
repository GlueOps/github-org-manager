...
class OrgChanges:  # pylint: disable=too-many-instance-attributes
    ...
    def create_repo(self, repo: str) -> None:
        """Document that a new repository was created"""
        self.update_repo(repo_name=repo, changed_permissions_for_teams=[f"🆕 Repo {repo} created"])
